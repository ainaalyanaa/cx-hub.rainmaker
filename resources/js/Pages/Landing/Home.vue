                        ...
                        <div class="relative group">
                            ...
                            <div class="relative bg-white bg-opacity-5 rounded-3xl p-1 border border-white border-opacity-10 shadow-2xl" style="backdrop-filter: blur(4px);">
                                <div class="relative overflow-hidden rounded-2xl">
                                    <img v-if="html.sections[0].image" :src="html.sections[0].image" alt="Rainmaker Dashboard" class="w-full h-auto transition-transform duration-700 group-hover:scale-105">
                                    <img v-else src="/landing/images/dashboard-helpdesk.png" alt="Rainmaker Dashboard" class="w-full h-auto transition-transform duration-700 group-hover:scale-105">
                                </div>
                            </div>
                        </div>
