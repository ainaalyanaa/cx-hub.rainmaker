...
import {
  require_cjs,
  require_lib
} from "./chunk-RO67L5A5.js";
import {
  axios_default
} from "./chunk-XS5TBV5T.js";
import {
  createSSRApp,
  defineComponent,
  h,
...
function k(t, e = new FormData(), r = null) {
  t = t || {};
  for (let i in t) Object.prototype.hasOwnProperty.call(t, i) && J(e, X(r, i), t[i]);
  return e;
}
function X(t, e) {
  return t ? t + "[" + e + "]" : e;
...
function J(t, e, r) {
  if (Array.isArray(r)) return Array.from(r.keys()).forEach((i) => J(t, X(e, i.toString()), r[i]));
...
var N = class {
  ...
  restoreScrollPositions() {
    this.page.scrollRegions && this.scrollRegions().forEach((e, r) => {
      ...
      if (i) typeof e.scrollTo == "function" ? e.scrollTo(i.left, i.top) : (e.scrollTop = i.top, e.scrollLeft = i.left);
      else return;
    });
  }
  isBackForwardVisit() {
  ...
  visit(e, { method: r = "get", data: i = {}, replace: s = false, preserveScroll: n = false, preserveState: u = false, only: f = [], headers: b2 = {}, errorBag: l = "", forceFormData: c2 = false, onCancelToken: v = () => {
    ...
    this.activeVisit = { ...S, onCancelToken: v, onBefore: R2, onStart: d, onProgress: p, onFinish: V2, onCancel: y2, onSuccess: D, onError: U, queryStringArrayFormat: I2, cancelToken: new AbortController() }, v({ cancel: () => {
      ...
      var _a;
      if (!this.isInertiaResponse(o)) return Promise.reject({ response: o });
      let a = o.data;
      ...
      if (this.isInertiaResponse(o.response)) return this.setPage(o.response.data, { visitId: M });
      ...
      } else if (o.response) $(o.response) && z.show(o.response.data);
      ...
      if (!axios_default.isCancel(o)) {
        let a = q(o);
        if (this.activeVisit && this.finishVisit(this.activeVisit), a) return Promise.reject(o);
      }
    });
  }
...
function P(e, o) {
  let n = typeof e == "string" ? e : null, l = typeof e == "object" ? e : o, t = n ? Je.restore(n) : null, p = (0, import_lodash2.default)(l), a = null, m2 = null, d = (r) => r, h3 = reactive({ ...t ? t.data : l, isDirty: false, errors: t ? t.errors : {}, hasErrors: false, processing: false, progress: null, wasSuccessful: false, recentlySuccessful: false, data() {
    ...
    let f = d(this.data()), g2 = { ...s, onCancelToken: (u) => {
      if (a = u, s.onCancelToken) return s.onCancelToken(u);
    }, onBefore: (u) => {
      if (this.wasSuccessful = false, this.recentlySuccessful = false, clearTimeout(m2), s.onBefore) return s.onBefore(u);
    }, onStart: (u) => {
      if (this.processing = true, s.onStart) return s.onStart(u);
    }, onProgress: (u) => {
      if (this.progress = u, s.onProgress) return s.onProgress(u);
    }, onSuccess: async (u) => {
      ...
      if (this.processing = false, this.progress = null, this.clearErrors().setError(u), s.onError) return s.onError(u);
    }, onCancel: () => {
      if (this.processing = false, this.progress = null, s.onCancel) return s.onCancel();
    }, onFinish: (u) => {
      if (this.processing = false, this.progress = null, a = null, s.onFinish) return s.onFinish(u);
    } };
...
var G = defineComponent({ props: { title: { type: String, required: false } }, data() {
  ...
  if (e.type.toString() === "Symbol(Text)") return e.children;
  if (e.type.toString() === "Symbol()") return "";
  if (e.type.toString() === "Symbol(Comment)") return "";
